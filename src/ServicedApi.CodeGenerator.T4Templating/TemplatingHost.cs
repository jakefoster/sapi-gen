...
// TODO: Clean this whole thing up stylistically and otherwise.  Ick.  JF
namespace org.ncore.ServicedApi.CodeGenerator.T4Templating
{
    // INSPIRED BY 
    ...
    //  INTERESTING: http://stackoverflow.com/questions/6192084/pass-an-object-to-t4-template
    public class TemplatingHost : MarshalByRefObject, ITextTemplatingEngineHost
    {
        ...
        public bool LoadIncludeText( string requestFileName, out string content, out string location )
        {
            ...
            {
                string fileLocation = Path.Combine( path, requestFileName );
        ...
        {
            return AppDomain.CreateDomain( "ServicedApi.CodeGenerator.T4Templating.TemplatingHost App Domain" );
        }
    }
}
